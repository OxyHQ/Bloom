...
- 18 built-in color presets: teal, blue, green, yellow, red, purple, pink, sky, orange, mint, oxy, faircoin, pumpkin, gray, brown, peach, rose, mono (`mono` is the colourless one — a seed at or below chroma 6 takes the greyscale scheme, so a hand-picked grey lands there too; only the status family stays semantic)
