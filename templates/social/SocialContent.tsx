...
import { defaultAvatarSource } from '../../src/avatar/default-avatar';
...
export function SocialLogo({ color, size = 28 }: { color?: string; size?: number }) {
...
export function SocialWidgets(_props: { authenticated?: boolean }) {
