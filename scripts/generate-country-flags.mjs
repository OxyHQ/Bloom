// @ts-check
/**
 * Generate the vendored country data behind `@oxy.so/bloom/phone-input`:
 *
...
const licenses =
  ...
  `packages below. Neither package is a dependency of \`@oxy.so/bloom\`; their data is vendored under\n` +
