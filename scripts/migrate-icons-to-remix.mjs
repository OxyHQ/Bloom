 ...
 *
 * Shapes handled:
 *   - named imports/re-exports from an icons module — `@oxy.so/bloom/icons`, the legacy
 *     `@oxyhq/bloom/icons`, a relative `…/icons` barrel — keep their specifier (the
 ...
 *     `import { Icons [as X] } from '@oxy.so/bloom'`, or the literal `Icons` (docs) —
 *     become `X.RiNew`.
...
/** `@oxy.so/bloom/icons`, `@oxyhq/bloom/icons`, `…/icons`, `…/icons/Check` → kind. */
