...
| --- | --- | --- |
| light | 0 / 256 | **8.23** (over black, web) |
| dark | 0 / 256 | **6.43** (over white, web) |
...
Measured on a **Pixel 8a** over a hard 10dp stripe pattern, sampling the same rows inside a chrome island and on the bare stripes beside it:
