...
**Unmeasured, and not measurable where everything else here was measured.** An
emulator has no real hardware decoders, so the question needs a physical device.
Until then this section is the decision, not the code.
