...
The tint follows the nearest published surface fill (`SurfaceLevelProvider`),
falling back to the theme background outside a surface. A blur inside a tonal
panel therefore fades into that panel's color.
