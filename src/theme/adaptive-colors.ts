...
function getAndroidColors(): AdaptiveColors | null {
  try {
    ...
    return {
      ...
      secondarySubtle: c(d.secondaryContainer),
      secondarySubtleForeground: c(d.onSecondaryContainer),
      tertiary: c(d.tertiary),
      tertiaryForeground: c(d.onTertiary),
      tertiarySubtle: c(d.tertiaryContainer),
      tertiarySubtleForeground: c(d.onTertiaryContainer),
      tint: c(d.primary),
...
function getIOSColors(): AdaptiveColors | null {
  try {
    ...
    return {
      ...
      // iOS has no named accent container/on-container pair. Use its readable
      // neutral container pair rather than inventing an alpha or on-color.
      secondarySubtle: c(i.systemGray6),
      secondarySubtleForeground: c(i.label),
      tertiary: c(i.systemTeal),
      tertiaryForeground: '#FFFFFF',
      tertiarySubtle: c(i.systemGray6),
      tertiarySubtleForeground: c(i.label),
      tint: c(i.systemBlue),
