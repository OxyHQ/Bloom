...
/**
 * The panel's heading row — BoardUI's `flex items-center gap-2 px-2 pt-1`:
...
export interface PopoverTitleProps {
  children?: React.ReactNode;
  /**
   * `'secondary'` is the group-label colour BoardUI's panels use above a list
...
/** The panel's closing row — BoardUI's `flex items-center gap-3 px-2 pb-2`. */
export type PopoverFooterProps = PopoverPartProps;

/**
 * The full-bleed rule between a panel's sections — BoardUI's
