...
function resolveVariant(
  ...
  switch (variant) {
    case 'secondary':
      return { background: colors.secondaryStrong, foreground: colors.secondaryStrongForeground };
    case 'tertiary':
      return { background: colors.tertiaryStrong, foreground: colors.tertiaryStrongForeground };
    case 'surface':
